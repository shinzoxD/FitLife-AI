  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col items-center rounded-xl border border-border bg-bg-secondary p-8 text-center">
        ...
        <h2 className="text-xl font-bold">Fuel Fit Score</h2>
      ...
      {Object.keys(nutrients).length > 0 && (
        <div className="rounded-xl border border-border bg-bg-secondary p-6">
          <h3 className="mb-4 font-semibold">Nutrient Breakdown</h3>
      ...
      {Object.keys(healthMetrics).length > 0 && (
        <div className="rounded-xl border border-border bg-bg-secondary p-6">
          <h3 className="mb-4 font-semibold">Profile Metrics Used</h3>
          <div className="grid gap-3 sm:grid-cols-2">
      ...
      {explanation && (
        <div className="rounded-xl border border-border bg-bg-secondary p-6">
          <h3 className="mb-4 font-semibold">AI Explanation</h3>
